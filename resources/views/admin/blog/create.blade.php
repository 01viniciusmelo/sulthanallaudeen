            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="heyy">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label url">Blog Url</label>
                                        <input type="hidden" name="url" id="url">
                                    </div>
                                </div>
                                <div class="form-group">
                                    @foreach($tags as $tag)
                                    <input type="checkbox" id="{{$tag->title}}" name="checkbox">
                                    <label for="{{$tag->title}}">{{$tag->title}}</label>
                                    @endforeach
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="content" cols="30" rows="5" class="form-control no-resize ckeditor" required></textarea>
