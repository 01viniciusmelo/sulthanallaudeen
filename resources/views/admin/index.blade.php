...
<head>
  ...
  <!-- Font Awesome -->
  <link href="{{ asset('/').('public/admin/css/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
  <!-- Ionicons -->
  <link href="{{ asset('/').('public/admin/css/font-awesome/css/ionicons.min.css') }}" rel="stylesheet">
  <!-- Theme style -->
