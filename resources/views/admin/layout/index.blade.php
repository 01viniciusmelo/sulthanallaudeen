...
<span class="hide" id="csrf_token">{{csrf_token()}}</span>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{asset('public/images/sulthan-allaudeen.jpg')}}" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sulthan Allaudeen</div>
                    <div class="email">sa@sulthanallaudeen.com</div>
